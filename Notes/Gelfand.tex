\documentclass[francais,a4paper,11pt]{amsart}
...
\begin{proof}
  \begin{enumerate}
  \item Si $h\in H$ alors $\hat{h}\in L$.
    \TODO{}
  \item $\hat{.}$ est un $Z$-morphisme.
    \TODO{}
  \item Si $l\in L$ alors $\tilde{l}\in H$.
    \TODO{}
  \item $\tilde{.}$ est un $Z$-morphisme.
    \TODO{}
  \item Pour tout $h\in H$, on a l'égalité $\tilde{\hat{h}} = h$.
    \TODO{}
  \item Pour tout $l\in L$, on a l'égalité $\hat{\tilde{l}} = l$.
    \TODO{}
  \end{enumerate}
\end{proof}
