...
Proof.
rewrite in_support; congr negb; apply/eqP/eqP => [| Hx].
- by rewrite -{3}(iter_pcycle s x) => -> /=.
- apply/eqP/cards1P; exists x.
...
Proof.
  ...
  apply/idP/eqP => [/cards1P [y Hy]|->]; last by rewrite cards1.
  by have:= pcycle_id s x; rewrite Hy inE => /eqP ->.
Qed.
